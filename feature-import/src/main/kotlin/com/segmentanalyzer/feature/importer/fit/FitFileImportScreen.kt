...
@Composable
fun FitFileImportScreen(
    uiState: FitImportUiState,
    ...
    Scaffold(
        ...
        Column(
            ...
            when (uiState) {
                FitImportUiState.Idle -> {
                    Text(
                        text = "Pick a .fit file from this device to import it as a ride.",
                    ...
                    Button(
                        ...
                        Text("Choose FIT file")
                    }
                }

                FitImportUiState.Importing -> {
